---
layout: post
title: Untyped lambda calculus in Python
...
about dependent typed lambda calculus to Python. This is the first
type : Untyped lambda calculus (with tests).

This code uses functions implemented/explained in the [Functional
programming in
Python](https://dhilst.github.io/2022/07/22/functional-programming-in-python.html) post
so you man want to reference it.
