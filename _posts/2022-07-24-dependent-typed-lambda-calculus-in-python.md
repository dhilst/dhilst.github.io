---
layout: post
title: Dependent Typed Lambda Calculus in Python
tags: [python, lambda-calculus, types, typechecking]
---

In this series of posts I will port [this
post](http://augustss.blogspot.com/2007/10/simpler-easier-in-recent-paper-simply.html?m=1)
about dependent typed lambda calculus to Python. This is the third and last one
_Dependent typed lambda calculus (with tests)_. I continue from
where I stopped in the second one: [Simply typed lambda calculus in
Python](https://dhilst.github.io/2022/07/23/simply-typed-lambda-calculus.html)

In comparison with the simply typed version the code changed little, I dropped the
mini parser because it would be too complicated to parse type since they contain arbitrary
terms now, you can find the full code here : https://github.com/dhilst/lampy3/blob/master/dtlc.py
...
In the next week I will look for more interesting dependent typed terms using this code. For now
it's just a blind port of the [simpler-easier-in-recent-paper-simply](http://augustss.blogspot.com/2007/10/simpler-easier-in-recent-paper-simply.html?m=1)
post and fixing the tests.

I would like to thank [augustss](https://www.blogger.com/profile/07327620522294658036), I don't
know him, but his post helped A LOT on wrapping this in my head, Thanks man!

That's it, if you know Python but not Haskell now you have a dependent typed lambda calculus
implementation to play on.
